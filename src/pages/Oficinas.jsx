    ...
    <main className="py-16">
      <div className="container mx-auto px-6">
        ...
        <section className="bg-white rounded-lg shadow p-6 mb-6">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="mt-2"><a href="https://maps.app.goo.gl/QkaBZFGJ9JNH4vyPA" target="_blank" rel="noreferrer" className="text-[#01c100] font-semibold">{lang === 'es' ? 'Ver en Google Maps' : 'View on Google Maps'}</a></p>
            </div>
            ...
            <div>
              ...
              <p className="mt-2"><a href="https://maps.app.goo.gl/oGHDAfgoRd2SH8qH8" target="_blank" rel="noreferrer" className="text-[#01c100] font-semibold">{lang === 'es' ? 'Ver en Google Maps' : 'View on Google Maps'}</a></p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-lg shadow p-6">
          ...
          <div className="mt-4">
            <a href="https://wa.me/50488281644" className="inline-block bg-[#01c100] text-black px-4 py-2 rounded font-semibold">WhatsApp</a>
          </div>
        </section>
      </div>
    </main>
